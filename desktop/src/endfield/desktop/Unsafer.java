...
public final class Unsafer {
	...
	public static void setReference(Field field, Object obj, Object value) {
		long offset = unsafe.objectFieldOffset(field);
	...
	public static Object getReference(Field field, Object obj) {
		long offset = unsafe.objectFieldOffset(field);

		return Modifier.isVolatile(field.getModifiers()) ?
				unsafe.getReferenceVolatile(obj, offset) :
				unsafe.getReference(obj, offset);
	}
	...
	static Object doGet(Object object, long fieldOff, Class<?> clazz) {
		if (clazz.isPrimitive()) {
			...
			return unsafe.getReference(object, fieldOff);
		}
	}
